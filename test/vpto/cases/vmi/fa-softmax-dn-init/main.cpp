...
void LaunchFa_dn_softmax_128x64(float *scores, __bf16 *x_exp, float *global_max, float *global_sum, __bf16 *nz_out, void *stream);
int main() {
  ...
  LaunchFa_dn_softmax_128x64(scoresDevice,xExpDevice,gmaxDevice,gsumDevice,nzDevice,stream);
